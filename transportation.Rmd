...
Something weird going on giving me a fatal error
# Sensitivity analysis using different emisison factors (See notees 4-xx)
```{r}
  ...
  mutate(emissions_kgCO2 = kg_CO2_pershortton*miles_traveled) %>%  # Calculate emissions per vendor
